...
contract factory {
    // we gonna implement the function in the constructor and call the setSlover directly;
    address ethernaut = 0xC53Ac9a3b69003A8A8e16580551C2AF3F324eaaF;
    ...
    constructor() {
        ...
        require(addr != address(0), "address zero were generated");
        (bool ok, ) = ethernaut.call(
            abi.encodeWithSignature("setSolver(address)", addr)
        );
        require(ok, "tx setslover is failed to excute");
    }

    function deployme() public {
        bytes memory initcode = hex"69602a60005260206000f3600052600a6016f3";
        address addr;
        assembly {
